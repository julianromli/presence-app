...
import { startWorkspaceBillingCheckout } from '../components/dashboard/workspace-billing-panel-state';
...
describe('workspace billing panel state', () => {
  it('redirects to checkout immediately without waiting for refresh work', async () => {
    ...
    expect(result).toEqual({ redirectedTo: 'https://mayar.example/invoice/123' });
