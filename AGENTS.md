...
- Indentation: 2 spaces; keep semicolons and existing quote style per file.
- Naming:
- Components: `PascalCase` exports, file names mostly `kebab-case.tsx`.
...
- `feat(scope): ...`, `fix(scope): ...`, `refactor(scope): ...`, `test: ...`.
